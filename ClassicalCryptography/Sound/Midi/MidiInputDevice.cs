...
/// </summary>
sealed partial class MidiInputDevice : MidiDevice
{
    #region Win32
    ...
    int _recordingPos;
    readonly object _recordingTrack0Lock = new();
        ...
        switch (msg)
        {
            ...
            case MIM_LONGDATA:
                ...
                if (IntPtr.Zero != hdr.lpData)
                {
                    ...
                    Marshal.Copy(new IntPtr(checked((int)hdr.lpData) + 1), payload, 0, payload.Length);
    ...
    static long PreciseUtcNowTicks
    {
        get
        {
