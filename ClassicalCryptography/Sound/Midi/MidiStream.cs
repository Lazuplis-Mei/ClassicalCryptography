...
public
#endif
partial class MidiStream : MidiOutputDevice
{
    #region Win32
    ...
    IntPtr _timerHandle;
    readonly MidiOutProc _outCallback;
    readonly TimerProc _timerCallback;
    ...
    void _SendBlock()
    {
        ...
        try
        {
            IntPtr eventPointer = new(headerPointer.ToInt64() + MIDIHDR_SIZE);
            var ofs = 0;
            var ptrOfs = 0;
