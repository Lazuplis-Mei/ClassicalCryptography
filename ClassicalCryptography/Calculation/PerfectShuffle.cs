...
public static class PerfectShuffle
{
    ...
    {
        BitsHelper.ToBitArray(0, 0),
        BitsHelper.ToBitArray(11, 4),
        BitsHelper.ToBitArray(13, 5),
        BitsHelper.ToBitArray(3, 3),
        BitsHelper.ToBitArray(13, 4),
        BitsHelper.ToBitArray(17, 5),
        BitsHelper.ToBitArray(3, 2),
        BitsHelper.ToBitArray(3, 5),
        BitsHelper.ToBitArray(7, 4),
        BitsHelper.ToBitArray(5, 3),
        BitsHelper.ToBitArray(31, 5),
        BitsHelper.ToBitArray(1, 4),
        BitsHelper.ToBitArray(9, 5),
        BitsHelper.ToBitArray(1, 1),
        BitsHelper.ToBitArray(3, 4),
        BitsHelper.ToBitArray(29, 5),
        BitsHelper.ToBitArray(7, 3),
        BitsHelper.ToBitArray(5, 4),
        BitsHelper.ToBitArray(1, 5),
        BitsHelper.ToBitArray(1, 2),
        BitsHelper.ToBitArray(19, 5),
        BitsHelper.ToBitArray(15, 4),
        BitsHelper.ToBitArray(1, 3),
        BitsHelper.ToBitArray(15, 5),
        BitsHelper.ToBitArray(9, 4),
        BitsHelper.ToBitArray(25, 5)
    };
