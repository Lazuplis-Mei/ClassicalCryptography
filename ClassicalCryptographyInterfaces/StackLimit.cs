...
public static class StackLimit
{
    ...
    public static bool CanAllocate(this int bytesCount) => bytesCount <= MAX_BYTE_SIZE;

    /// <summary>
    /// 是否能申请栈空间
    /// </summary>
    /// <param name="stringLength">要申请的字符串长度</param>
    public static bool CanAllocateString(this int stringLength) => stringLength <= MAX_CHAR_SIZE;
}
